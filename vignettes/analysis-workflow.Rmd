...
This writes `mitodrift_demo/mitodrift_object.rds` and `mitodrift_demo/tree_annotated.newick`.
The workflow below uses the same mutation table and an annotated tree generated with those settings.
