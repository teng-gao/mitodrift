...
// score_tree_bp
double score_tree_bp(arma::Col<int> E, std::vector<double> logP, std::vector<double> logA, int n, int C, int m, int root);
...
double score_tree_bp_wrapper(arma::Col<int> E, std::vector< std::vector<double> > logP_list, std::vector<double> logA);
